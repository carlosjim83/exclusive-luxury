...
| **PLA-14** | Fallo de sincronización de inventario en tiempo real | Lag o fallo en la sincronización de stock de consignación con marcas socias, generando venta de artículos no disponibles (overselling) o catálogos vacíos. | 4 | 4 | **16** | Mitigar | Arquitectura event-driven (webhooks/cola de mensajes) con idempotency keys; circuit breakers manuales; jobs de reconciliación cada 60 seg; validación de schema con alertas. | CTO / Integraciones | 8.000€ | Tasa de overselling | > 1 % |
...
**Reserva total asignada a categoría Plataforma**: **110.000€**  
